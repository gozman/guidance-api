...
app.post('/instructions', async (req: Request, res: Response) => {
  try {
    let { username, password, title, content } = req.body as CreateInstructionBody;
...
interface DeleteInstructionBody {
  username?: string;
  password?: string;
  title?: string;
}

app.post('/instructions/delete', async (req: Request, res: Response) => {
  try {
    let { username, password, title } = req.body as DeleteInstructionBody;
